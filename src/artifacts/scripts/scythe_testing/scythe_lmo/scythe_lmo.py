...
def create_parser(db, os="windows"):
    ...
    epilog =  'Example usage: scythe_testing.scythe_lmo --ports [80,443,53] --domain "testdomain.com"'
    parser = ArgumentParser(prog="scythe_lmo", description="This is a checker to see if a host can talk outbound to LetMeOutOfYour.net",
                            epilog=epilog)
    parser.add_argument(
